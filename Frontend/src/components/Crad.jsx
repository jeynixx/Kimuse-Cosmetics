...
export default function Crad(props) {
  ...
  return (
    <>
      <Link
        className=" no-underline text-purple-900"
        to={`/products/${props.id}/info`}
      >
        <div key={props.id} className="group ">
          <div className="  group-hover:border-solid group-hover:border-purple-500 group-hover:border group-hover:text-purple-500">
            <div className=" relative h-auto w-full">
              ...
              <div className="absolute top-0 right-1 px-2 py-1 font-bold text-red-700">
