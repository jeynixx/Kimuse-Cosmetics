    ...
    <div className="container">
      <div className="flex flex-col items-center justify-center h-screen">
        <form onSubmit={handleSubmit}>
          <p className=" text-2xl font-bold mb-3 text-purple-900">Set your new password.</p>

          {status && (
            <p className=" text-center pl-3 border-2 border-purple-500 text-purple-700 text-sm bg-purple-200">
          ...
          <div className="relative mb-3">
            <input
              className={` focus:outline-none focus:ring focus:ring-purple-700 border-2  border-solid ${
                errors.password_confirmation ? "border-red-500" : "border-purple-900"
              } px-2 py-2 text-lg w-full `}
              type="password"
              onFocus={handleFocus}
              onBlur={handleBlur}
