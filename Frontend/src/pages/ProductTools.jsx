    ...
    <>
      ...
      <div className="container h-screen">
        ...
        <section className="mb-5">
          <div className=" mb-5">
            <h2 className=" font-bold text-purple-900">BEAUTY TOOLS</h2>
            <p>Browse for 
              <span> </span>
              <Link to={"/womens"} className="text-purple-900">
                <span className="underline hover:font-semibold hover:text-purple-500" >makeups</span>
              </Link>
              .
            </p>
          </div>
