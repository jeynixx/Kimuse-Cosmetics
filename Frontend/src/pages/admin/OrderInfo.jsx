    ...
    <>
      ...
      <div className=" container h-full">
        <div className=" block md:flex justify-between mb-3 container md:pt-5">
          <h1 className="text-purple-900">Ordered Info</h1>
        </div>

        <div className="flex flex-col">
          <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div className="inline-block min-w-full py-2 sm:px-6 lg:px-8">
              <p className="text-purple-900">Order ID: {id}</p>
              <p className="text-purple-900">Tracking Number: {tracking_no}</p>
              <p className="text-purple-900">address: {address}</p>
              <p className="text-purple-900">status: {status}</p>

              <form onSubmit={(event) => handleSubmit(event, id)}>
                <label htmlFor="status" className="text-purple-900">Set Status:</label>
                <select
                  name="status"
                  id="status"
                  value={status}
                ...
                <button
                  className="py-2 px-4 bg-purple-900 text-white font-bold"
                  type="submit"
                >
                  Update
                </button>
