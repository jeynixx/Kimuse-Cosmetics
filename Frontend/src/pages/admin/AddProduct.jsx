  ...
  return (
    <>
      <div
        className={` ${
          success
            ? " fixed bg-purple-500 opacity-80 left-0 h-full w-full z-10"
            : "hidden"
        }`}
      ></div>
      ...
      <div className="container">
        <div>
          <div>
            <h1 className=" text-center text-purple-900 pt-10">Add Product</h1>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              <label className=" pl-2 font-bold text-purple-900">Description</label>
            ...
            <div className="grid gap-3 grid-cols-1 md:grid-cols-4 mb-3">
              <div className=" flex flex-col">
                <label className=" pl-2 font-bold text-purple-900">Price</label>
                <input
                  className={` focus:outline-none focus:ring focus:ring-purple-900 border-2  border-solid ${
              ...
              <div className=" flex flex-col">
                <label className=" pl-2 font-bold text-purple-900">Quantity</label>
                <input
                  className={` focus:outline-none focus:ring focus:ring-purple-900 border-2  border-solid ${
                    error.quantity ? "border-red-700" : "border-purple-900"
                  } px-2 py-2 text-lg w-full `}
                  type="number"
                  name="quantity"
                  value={quantity}
              ...
              <div className=" flex flex-col">
                <label htmlFor="listing" className=" pl-2 font-bold text-purple-900">
                  Listing
                </label>
                <select
                  className={` focus:outline-none focus:ring focus:ring-purple-900 border-2  border-solid ${
            ...
            <div className="mb-3 flex flex-col justify-center">
              <div className=" flex flex-col mb-3 ">
                <label className=" pl-2 font-bold text-purple-900">Image</label>
                <input
                  className={` focus:outline-none focus:ring focus:ring-purple-900 border-2  border-solid ${
                    error.image ? "border-red-700" : "border-purple-900"
                  } px-2 py-2 text-lg w-full `}
                  type="file"
                  id="image"
                  name="image"
            ...
            <div className=" text-center">
              <button
                className=" py-2 px-4 bg-purple-900 text-white font-semibold hover:bg-purple-500"
                type="submit"
              >
                Submit
              </button>
      ...
      {success && (
        <div className="fixed h-full inset-0 flex items-center justify-center z-20">
          <div className=" bg-white p-5 flex flex-col items-center border-solid border-purple-900 border-2">
            ...
            <button
              className="mx-2 px-4 py-2 border-solid border-purple-500 border-2 font-semibold hover:bg-purple-500 text-white bg-purple-900"
              type="button"
