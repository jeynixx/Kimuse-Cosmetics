  ...
  return (
    <>
      ...
      <div className=" lg:container container-fluid">
        <div>
          <h1 className=" font-extrabold text-purple-900">YOUR BAG</h1>
        </div>
        <div>
          {!cartItems?.length ? (
            <>
              <div className=" flex flex-col items-center justify-center h-96">
                ...
                <div>
                  <Link to={"/"} className="text-purple-900 hover:text-purple-500">Shop Now!</Link>
                </div>
              </div>
            </>
          ) : (
            <>
              <div className=" flex flex-col lg:flex-row">
                <div className="flex-auto">
                  <p className="m-0 text-2xl text-purple-900">
                          ...
                          <div className="flex justify-between">
                            ...
                            <div className="1/5 text-right">
                              <button
                                ...
                                className="lg:py-2 lg:px-4 px-2 py-1 font-semibold border-2 border-solid border-purple-900 hover:border-purple-500 hover:bg-purple-200 hover:text-purple-500"
                              >
                                X
                              </button>
                            </div>
                ...
                <div className="flex-auto lg:w-8/12 lg:px-3  lg:m-3">
                  ...
                  <div className="sticky top-0 lg:pt-5">
                    <div className=" border-2 border-solid p-5 border-purple-900">
                      <h2 className=" font-black text-purple-900">ORDER SUMMARY</h2>
                      <div className=" flex justify-between">
                        <p className="text-purple-900">{getTotalQuantity()} items</p>
                        <p className="text-purple-900">₱{formatPrice(getTotalPrice())}</p>
                      </div>
                      <div className=" flex justify-between">
                        <p className="text-purple-900">Delivery</p>
                        <p className="text-purple-900">FREE</p>
                      </div>
                      <hr />
                      <div className=" flex justify-between">
                        <p className=" font-bold text-purple-900">Total price</p>
                        <p className=" font-bold text-purple-900">
                          ₱{formatPrice(getTotalPrice())}
                        </p>
                      </div>
                      <Link to={"/checkout"}>
                        <button className="py-2 px-4 font-semibold text-white bg-purple-900 hover:bg-purple-500 w-full">
                          Checkout →
                        </button>
                      </Link>
                    </div>
